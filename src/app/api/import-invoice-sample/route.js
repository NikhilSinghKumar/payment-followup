export async function GET() {
  const csv = `company_code,invoice_number,invoice_date,due_date,payment_terms,invoice_amount,deduction_amount,other_charges,notes
ABC001,INV-0001,2026-04-10,2026-05-10,30,11800,0,0,April Invoice
