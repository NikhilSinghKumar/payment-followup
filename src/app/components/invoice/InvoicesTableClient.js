...
export default function InvoicesTableClient({ invoices = [] }) {
  ...
  return (
    <div className="relative">
      ...
      {selectedIds.length > 0 && (
        <div className="fixed bottom-6 left-1/2 z-40 -translate-x-1/2 flex items-center gap-4 rounded-2xl border border-zinc-700 bg-zinc-900/95 px-5 py-3 text-white shadow-2xl backdrop-blur-md animate-in slide-in-from-bottom-4 duration-200">
          <div className="flex items-center gap-2.5 border-r border-zinc-700 pr-4">
            ...
            <div>
              ...
              <div className="text-[10px] text-zinc-400">
                Grouped into <strong>{selectedClientsCount}</strong> client
                statement{selectedClientsCount > 1 ? "s" : ""} • Total:{" "}
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-2 text-xs font-bold text-white shadow-md transition hover:from-blue-500 hover:to-indigo-500 hover:scale-102"
            >
              <Mail size={14} />
              <span>Send Bulk Reminders ({selectedClientsCount} Clients)</span>
            </button>
